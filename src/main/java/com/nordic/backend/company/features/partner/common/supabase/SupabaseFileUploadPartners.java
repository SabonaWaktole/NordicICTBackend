package com.nordic.backend.company.features.partner.common.supabase;
...
@Component
public class SupabaseFileUploadPartners {
    ...
    public SupabaseFileUploadPartners(@Value("${supabase.url}") String supabaseUrl) {
        ...
        try {
            ...
            try {
                uploadUri = UriComponentsBuilder.fromHttpUrl(supabaseUrl)
                        .path("/storage/v1/object/PartnersPhotos/"+fileName)
                        .queryParam("bucket", "PartnersPhotos")
            ...
            if (response.getStatusCode().is2xxSuccessful()) {
                return baseUri.resolve("/storage/v1/object/public/PartnersPhotos/" + fileName).toString();
            } else {
